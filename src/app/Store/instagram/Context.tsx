...
export const InstagramContext = React.createContext({} as InstagramContextProps);

export const InstagramContextProvider: React.FC<Props> = (props) => {
  const [state, dispatchInstagram] = React.useReducer(instagramReducer, {instagramAccounts: props.instagramAccounts, instagramMedias: initInstagramMedias});
