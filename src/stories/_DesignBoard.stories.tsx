...
import { switchingTransition } from '../app/View/tablet/Modal/Modal/context/switchingTransition';
    ...
    <div className={classes.root}>
      <div className={`${classes.itemBox} ${classes.colorBox}`}>
        <div className={`${classes.color} ${classes.colorPrimary}`}>
          <span className={classes.colorSpan}>プライマリーカラー</span>
        </div>
        <div className={`${classes.color} ${classes.colorSecondary}`}>
          <span className={classes.colorSpan}>セカンダリカラー</span>
        </div>
      </div>
